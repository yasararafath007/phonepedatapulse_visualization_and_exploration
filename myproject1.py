...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By yasar arafath",
                   
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *yasar arafath*!
...
mydb = sqlite3.connect("phonepe1_data.db")
cursor = mydb.cursor()
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("### :violet[Technologies used :] Github Cloning, Python, Pandas, sqlite3, sqlite-connector-python, Streamlit, and Plotly.")
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/yasararafath007/phonepedatapulse_visualization_and_exploration")
